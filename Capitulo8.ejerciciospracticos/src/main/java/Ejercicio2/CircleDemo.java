...
public class CircleDemo {
	...
	public static void main(String[] args) {
        ...
        System.out.println("Radio inicial (usando getDimension): " + myCircle.getDimension()); 
        ...
        System.out.println("Nuevo radio (usando getDimension): " + myCircle.getDimension()); 
        System.out.println("\nIntentando establecer dimensiones con un array de 2 elementos...");
        int[] badArray = { 20, 30 };
        myCircle.setDimensions(badArray);
     
        System.out.println("Radio después del intento fallido (debe ser 8): " + myCircle.getDimension()); 
	}
}
