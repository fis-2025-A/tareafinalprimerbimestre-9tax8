...
public class EmpleadoAsalariado extends Empleado{
   ...
   public EmpleadoAsalariado( String nombre, String apellido, String nss,double salario,Fecha fecha ) 
   {
      super( nombre, apellido, nss, fecha ); // los pasa al constructor de Empleado
