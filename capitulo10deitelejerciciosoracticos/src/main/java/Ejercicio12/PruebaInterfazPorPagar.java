...
public class PruebaInterfazPorPagar {
    ...
    PorPagar objetosPorPagar[] = new PorPagar[ 4 ];
     ...
     objetosPorPagar[ 2 ] =(PorPagar) new EmpleadoAsalariado( "John", "Smith", "111-11-1111", 800.00 );
     objetosPorPagar[ 3 ] = (PorPagar) new EmpleadoAsalariado( "Lisa", "Barnes", "888-88-8888", 1200.00 );
